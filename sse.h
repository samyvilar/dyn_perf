...
static const struct {
    ...
    const struct {
        const struct {
            const sse_intgl_load_t  load, load_align;

            const sse_intgl_store_t store, store_align;

            const sse_bin_intgl_t and, or, xor;
            ...
            const sse_bin_intgl_imm_int_t
                lshft_imm[9],
                rshft_lgcl_imm[9],
                rshft_arith_imm[9]
            ;

            const sse_unr_intgl_t
                extd_sign_bit[9];
