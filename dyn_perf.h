...
static_inline void _upd_entry(dyn_perf_t *self, entry_t **slot, entry_t *entry) {
...
typedef struct oprtns_t {const act_t empty, collsn, match;} oprtns_t;
static struct {oprtns_t entry, table;} acts = {
    .entry = {.empty = (void *)_set_entry,           .match = (void *)_upd_entry, .collsn = (void *)_cvt_to_table},
    .table = {.empty = (void *)_set_entry_sub_table, .match = (void *)_upd_entry, .collsn = (void *)_modf_sub_table}
};
